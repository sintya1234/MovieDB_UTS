...
private NowPlaying page;

  //  public NowPlayingAdapter(List<NowPlaying.Results> listNowPlaying) {
...
//                Navigation.findNavController(v).navigate(R.id.action_nowPlayingFragment_to_movieDetailFragment2, bundle);
//           }
//       });
