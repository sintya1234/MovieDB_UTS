...
public class movieDetailFragment extends Fragment {
    ...
    private TextView title_details_movie, avg_details_movie, overview_details_movie,
            ...
            genre_details_movie;
    private ImageView background_details_movie, poster_details_movie;
    ...
    private Observer<Movies> showResultMovie = new Observer<Movies>() {
        ...
        public void onChanged(Movies movies) {
            ...
            String Gbackround = movies.getBackdrop_path().toString();
...
//            rv_card_details_companies.setAdapter(adapter);
            ...
            Glide.with(movieDetailFragment.this).load(Const.IMG_URL + Gposter).into(poster_details_movie);
            Glide.with(movieDetailFragment.this).load(Const.IMG_URL + Gbackround).into(background_details_movie);
